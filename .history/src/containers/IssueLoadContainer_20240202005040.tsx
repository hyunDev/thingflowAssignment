...
const IssueLoadLayout = styled.div`
  ...
  height: 100%;
`
interface IssueLoadContainerType {
  issueCardClick: () => void
}
const IssueLoadContainer = ({ issueCardClick }: IssueLoadContainerType) => {
  ...
  return (
    <IssueLoadLayout>
      <ListItem issueList={issueList} issueCardClick={issueCardClick} />
